...
def emotionImage(emotion):
	...
	#if image is None: image = cv2.imread('Emojis/none.jpeg')
	return image
...
# --------------------------------------------------------------------------------
#r'C:\Users\migue\OneDrive\Documentos\Servicio Social\Reconocimiento\Data'
dataPath = 'C:/xampp/htdocs/Servicio/Data' #Cambia a la ruta donde hayas almacenado Data
	...
	for (x,y,w,h) in faces:
		...
		if method == 'EigenFaces':
			if result[1] < 5700:
				...
				image = cv2.resize(image, (300, frame.shape[0]))  # Redimensiona 'image' a la altura de 'frame'
